...
STARTING_POSITION = [(0, 0), (-20, 0), (-40, 0)] #Position of three turtles together will be shown as a complete snake. One turtle is 20x20 pixel. SO the next one follows it on -20 pixel, and then one follows it on -40.
MOVING_POSITION = 20
